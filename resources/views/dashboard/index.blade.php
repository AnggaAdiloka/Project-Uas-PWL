...
<div class="row">
    <div class="col-xl-4 col-md-6">
        <div class="mb-4 text-white card bg-primary">
            <div class="card-body">{{ $carCount }} Mobil</div>
    ...
    <div class="col-xl-4 col-md-6">
        <div class="mb-4 text-white card bg-warning">
            <div class="card-body">{{ $userDetails->count() }} Pelanggan</div>
            <div class="card-footer d-flex align-items-center justify-content-between">
                <a class="text-white small stretched-link" href="{{ route('pelanggan.index') }}">View Details</a>
                <div class="text-white small"><i class="fas fa-angle-right"></i></div>
            </div>
        </div>
    </div>
    <div class="col-xl-4 col-md-6">
        <div class="mb-4 text-white card bg-success">
            <div class="card-body">{{ $transactionCount }} Transaksi</div>
            <div class="card-footer d-flex align-items-center justify-content-between">
